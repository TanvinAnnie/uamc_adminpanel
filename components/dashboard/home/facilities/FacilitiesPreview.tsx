...
selectedIndex < activeFacilities.length
...
"bg-[#008B45] text-white shadow-lg"
...
"bg-slate-800 text-slate-400 group-hover:bg-emerald-400/20 group-hover:text-emerald-400"
